...
@section('content')
    <div class="mx-auto mt-10 max-w-3xl rounded-xl bg-white p-6 shadow-md">
        <h2 class="mb-6 text-2xl font-semibold">Edit Clinic</h2>
        <form
            action="{{ route('dashboard.clinics.update', $clinic->id) }}"
            method="POST"
        ...
        >
            ...
            <div>
                ...
                <div id="logoPreviewWrapper">
                    <img
                        id="logoPreview"
                        src="{{ $clinic->logo ? asset($clinic->logo) : '#' }}"
                        alt="Logo Preview"
                        class="{{ $clinic->logo ? '' : 'hidden' }} h-24 w-24 rounded-md border border-gray-300 object-cover"
                    />
                </div>
                <input
                    type="file"
            ...
            <div class="flex flex-col justify-end">
                ...
                <input
                    ...
                    name="clinic_name"
                    id="name"
                    value="{{ old('clinic_name', $clinic->clinic_name) }}"
            ...
            <div>
                ...
                <input
                    ...
                    name="clinic_address"
                    id="clinic_address"
                    value="{{ old('clinic_address', $clinic->clinic_address) }}"
            ...
            <div>
                ...
                <input
                    ...
                    name="visit_time"
                    id="visit_time"
                    value="{{ old('visit_time', $clinic->visit_time) }}"
