    ...
    <div class="w-full sm:px-6">
        <div class="rounded-tl-lg rounded-tr-lg bg-gray-100 px-4 py-4 md:px-10 md:py-7">
            <div class="items-center justify-center sm:flex">
                ...
                >
                    Menstrual Diseases Management
                </p>
            </div>
            
            <div class="mt-5 grid grid-cols-1 gap-5 md:mt-10 md:grid-cols-2 md:gap-20">
                <form method="POST" class="flex gap-5" action="{{ route('dashboard.menstrual-diseases.store') }}">
                    @csrf
                        ...
                        <div class="w-full">
                            <label class="relative block w-full cursor-text">
                                <input
                                    ...
                                    id="name"
                                    name="name"
                                    placeholder="Menstrual Diseases Name"
                ...
                <x-search
                    :data="[
                        'route' => 'dashboard.menstrual-diseases',
                        'search' => $search,
                    ]"
                />
            </div>
        ...
        <x-pagination :data="[
            'links' => $menstrualDiseases->toArray()['links'],
        ]" />
    </div>
@endsection
